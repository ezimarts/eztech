...
resource "aws_cloudfront_distribution" "website" {
  ...
  viewer_certificate {
    ...
    acm_certificate_arn            = var.domain_name == "" ? null : (var.hosted_zone_id == "" ? aws_acm_certificate.website[0].arn : aws_acm_certificate_validation.website[0].certificate_arn)
